...
fo = va_to_fo(va)
start_fo = fo
while start_fo > fo - 0x1000 and data[start_fo] != 0xcc:
    start_fo -= 1
start_fo += 1
while data[start_fo] == 0xcc: start_fo += 1

func_va = image_base + (start_fo - 0x400 + 0x1000)
print(f'_doClientAVCtrl starts at VA: 0x{func_va:x} (FO: 0x{start_fo:x})')

code = data[start_fo : start_fo + 0x1000]
